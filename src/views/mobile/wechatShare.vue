  ...
  <main class="wechat-share" id='wechat-share'>
    ...
    <div v-if='!success'>
      <div class="logo" @click='logout'>
          <img src="../../assets/mobile/footNav/share_logo.png" alt="">
      </div>
      <!-- <div class="coop">
      ...
      <div class="input-form">
          <div class="main-form">
              <p class='title'>{{user_name}}{{ $t("mobile.share.send") }}</p>
              <p class='title'>
                  ...
                  {{ $t("mobile.share.count") }}
                  <span style='vertical-align:middle;margin-top:-0.09rem;display:inline-block;width: 1rem;height: 1px;background-color: #bababa'> </span>
              </p>
              <p class='mes'>{{ $t("mobile.share.mes") }}</p>
              ...
              <p class='input verify'>
                  ...
                  <span v-if="!startCode" @click='getCode'>{{ $t("mobile.share.sendCode") }}</span>
                  <span v-else>{{time}} 秒</span>
              </p>
              <a class='btn' type='button' @click='go'>{{ $t("mobile.share.getNow") }}</a>
          </div>
      </div>
      <p style='text-align: center;color: #4782D7;font-size: 0.35rem;margin-top: 0.5rem'>{{ $t("mobile.share.title1") }}</p>
      <p style='text-align: center;color: #ffff;font-size: 0.4rem;'>{{ $t("mobile.share.title2") }}</p>
      <p style='text-align: center;color: #4782D7;font-size: 0.35rem;'>{{ $t("mobile.share.title3") }}</p>
    ...
    <p style='text-align: center;font-weight: 200;font-size: 0.3rem;color: rgba(255,255,255,0.5);'>{{ $t("mobile.share.bottom1") }}</p>
    <p style='text-align: center;font-weight: 200;font-size: 0.3rem;color: rgba(255,255,255,0.5);padding-bottom: 1rem;'>{{ $t("mobile.share.bottom2") }}</p>
