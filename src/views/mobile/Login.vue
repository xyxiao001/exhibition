<template>
  <main class="login">
    <header>
      <img src="../../assets/mobile/footNav/login-logo.png" alt="" >
    </header>
    <section class="login-box">
      ...
      <div class="code">
        ...
        <span class="get-code" v-if="!startCode" @click="getCode">获取</span>
        <span class="get-code get-code-active " v-else>{{time}} 秒</span>
      </div>
      ...
      <x-button class="go" v-if="!loading" @click.native="go">登录</x-button>
      <x-button class="go" v-else>加载中...</x-button>
    </section>
